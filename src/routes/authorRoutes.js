...
authorsRouter.get('/',function(req,res){
    ...
    .then(function(authors){
        res.render("authors",{
            nav:[{link:'/books',name:'Books'},{link:'/authors',name:'Authors'},{link:'/admin',name:'Add Books'},{link:'/admin1',name:'Add Authors'}],
            title:'Library App',
            authors  
        });
    });
...
authorsRouter.get('/:id',function(req,res){
    ...
    .then(function(author){
        res.render('author',{
            nav:[{link:'/books',name:'Books'},{link:'/authors',name:'Authors'},{link:'/admin1',name:'Add Authors'}],
            title:'Library App',
            author
        });
    });
